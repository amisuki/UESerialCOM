...
public:
	...
	ELineEnd WriteLineEnd = ELineEnd::n;

public:
	USerialCOM();
	virtual ~USerialCOM() override;
...
protected:
	void* m_hIDComDev = nullptr;

	// Forward declaration
	typedef struct _OVERLAPPED OVERLAPPED;
	
	// These are pointers to be able to use OVERLAPPED with forward declaration
	OVERLAPPED* OverlappedRead = nullptr;
	OVERLAPPED* OverlappedWrite = nullptr;
